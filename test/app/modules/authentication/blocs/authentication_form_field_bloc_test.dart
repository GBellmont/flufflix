  ...
  group('AuthenticationFormFieldBlocTest', () {
    group('SetErrorState', () {
      blocTest<AuthenticationFormFieldBloc, AuthenticationFormFieldState>(
        ...
        act: (bloc) => bloc.add(const SetAuthFormFieldValidatedErrorEvent(
    ...
    group('SetVisibleContent', () {
      blocTest<AuthenticationFormFieldBloc, AuthenticationFormFieldState>(
        ...
        act: (bloc) => bloc.add(const ToggleAuthFormFieldVisibilityEvent(
