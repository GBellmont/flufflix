...
class SerieTrailersModel extends SerieTrailersEntity<TrailerModel>
    implements ListContentListItemInterface {
  const SerieTrailersModel({required super.trailers});

  factory SerieTrailersModel.fromJson(Map<String, dynamic> jsonResponse) {
    try {
      return SerieTrailersModel(
